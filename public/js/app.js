...
window.typeahead = __webpack_require__(178);
window.Bloodhound = __webpack_require__(180);
...
window.Jasny = __webpack_require__(201);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
(function (factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(0), __webpack_require__(173)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
var PersistentStorage = __webpack_require__(186);
var _ = __webpack_require__(3);
...
var storage2 = __webpack_require__(187);
var _ = __webpack_require__(3);
...
var cookie = __webpack_require__(190);
...
var numKeys = __webpack_require__(189);
...
var _ = __webpack_require__(3);
var ajax = __webpack_require__(193);
...
/* scopeId */
var __vue_scopeId__ = "data-v-bf2ab392"
/* moduleIdentifier (server only) */
...
Component.options.__file = "resources/assets/js/components/CycleSignup.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-bf2ab392", Component.options)
  } else {
    hotAPI.reload("data-v-bf2ab392", Component.options)
  }
...
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-bf2ab392\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CycleSignup.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-bf2ab392\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CycleSignup.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.fade-enter-active[data-v-bf2ab392], .fade-leave-active[data-v-bf2ab392] {\n  -webkit-transition: opacity .5s;\n  transition: opacity .5s;\n}\n.fade-enter[data-v-bf2ab392], .fade-leave-to[data-v-bf2ab392] /* .fade-leave-active below version 2.1.8 */ {\n  opacity: 0;\n}\ntime.icon.icon-sm[data-v-bf2ab392] {\n    font-size:0.6em;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        buildPayload: function buildPayload() {
            ...
            if (this.subSignup == false) {
                ...
                payload['weeks'] = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.map(__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.filter(this.weekPayload(), function (week) {
                    return week.attending;
                }), 'id');
            }
        ...
        weekPayload: function weekPayload() {
            var weeks = [];
        ...
        captainPayload: function captainPayload() {
        ...
        clickConfirmEdit: function clickConfirmEdit(event) {
            this.editMode = true;
        ...
        clickFinish: function clickFinish() {
            ...
            var url = '/api/cycles/' + this.cycle.name + '/signups';

            if (this.subSignup) {
                url = '/api/cycles/' + this.cycle.name + '/subs';
            }
            this.status = 'sending';
            axios.post(url, this.buildPayload()).then(function (response) {
                console.log(response.data);
                _this.status = 'updating';
        ...
        clickCycleDetails: function clickCycleDetails() {
        ...
        clickContinue: function clickContinue() {
            if (this.editMode == true) {
                ...
                if (this.show == 'availability' && this.numOfWeeksSigningUp >= 3 && this.will_captain == null) {
            ...
            if (this.show == 'payment') {
                ...
                if (this.signingUpForToday) {
                    if (this.cycleSignupLate || this.cycleSignupSuperLate || this.subSignupSuperLate) this.show = 'late_message';
                    return;
                }
        ...
        clickWeek: function clickWeek(event) {
            var index = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.indexOf(this.weeksAttending, parseInt(event.currentTarget.dataset.week_id));
            if (index != -1) {
        ...
        clickPref: function clickPref(event) {
            console.log('clickPref', event.currentTarget.dataset.div_pref);
            if (event.currentTarget.dataset.div_pref == 'genderOnly') {
                if (__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.toLower(this.user.gender) == 'male') {
        ...
        clickCaptain: function clickCaptain(event) {
        ...
        month: function month(value) {
            return __WEBPACK_IMPORTED_MODULE_0_moment___default()(value).format('MMMM');
        },
        dayOfMonth: function dayOfMonth(value) {
            return __WEBPACK_IMPORTED_MODULE_0_moment___default()(value).format('D');
        },
        ...
        isToday: function isToday(momentObj) {
            return momentObj.startOf('day', 'd').isSame(__WEBPACK_IMPORTED_MODULE_0_moment___default()().startOf('day'), 'd');
        },
        weekAttending: function weekAttending(weekId) {
        ...
        div_pref: function div_pref(divPref) {
            var divPrefPart1 = 'gender';
            var divPrefPart2 = 'Flexible';
    ...
    computed: {
        timeFontSize: function timeFontSize() {
            return this.cycle.weeks.length > 3;
        },
        division_preference: function division_preference() {

            if (this.division_preference_first == this.division_preference_second) {
                return __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.upperFirst(this.division_preference_first) + " only";
            } else {
                return __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.upperFirst(this.division_preference_first) + "/" + __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.upperFirst(this.division_preference_second);
            }
        },
        weeksAttendingList: function weeksAttendingList() {
            if (this.cycle.weeks.length == this.numOfWeeksSigningUp) {
                return "All " + this.numOfWeeksSigningUp + " weeks";
            }

            var weeksAttendingSorted = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.sortBy(this.weeksAttending, [function (o) {
                return o.week;
            }]);
            var html = '<ul class="mb-1">';
            for (var i = 0, len = weeksAttendingSorted.length; i < len; i++) {
                var week = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.find(this.cycle.weeks, { 'id': weeksAttendingSorted[i] });
                html += "<li>" + __WEBPACK_IMPORTED_MODULE_0_moment___default()(week.starts_at).format("dddd, MMMM Do") + "</li>";
            }
            return html += "</ul>";
        },
        paymentConfirmation: function paymentConfirmation() {
            var paymentMethod = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.startCase(__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.toLower(this.payment_method.replace(/_/g, " ")));

            return 'Will pay <strong>balance + $' + this.fees + '</strong> via <strong>' + paymentMethod + '</strong>.';
        },
        numOfWeeksSigningUp: function numOfWeeksSigningUp() {
            return this.weeksAttending.length;
        },
        firstWeekOfCycle: function firstWeekOfCycle() {
            return this.cycle.weeks[0];
        },
        cycleSignupAllowed: function cycleSignupAllowed() {
            // time is before start time with a 30 minute grace period
            console.log('cycleSignupAllowed', __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBefore(__WEBPACK_IMPORTED_MODULE_0_moment___default()(this.cycle.starts_at).add(30, 'minutes')));
            return __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBefore(__WEBPACK_IMPORTED_MODULE_0_moment___default()(this.cycle.starts_at).add(30, 'minutes'));
        },
        cycleSignupOpen: function cycleSignupOpen() {
            // time is before signup closes time
            var closesAt = __WEBPACK_IMPORTED_MODULE_0_moment___default()(this.cycle.signup_closes_at);
            return __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBefore(closesAt);
        },
        cycleSignupLate: function cycleSignupLate() {
            // time is between after signup closes time and 90 minutes before game time
            var closesAt = __WEBPACK_IMPORTED_MODULE_0_moment___default()(this.cycle.signup_closes_at);
            var lateCutoff = __WEBPACK_IMPORTED_MODULE_0_moment___default()(this.cycle.starts_at).subtract(90, 'minutes');

            console.log('lateCutoff', __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBetween(closesAt, lateCutoff));
            return __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBetween(closesAt, lateCutoff);
        },
        cycleSignupSuperLate: function cycleSignupSuperLate() {
            // time is between after 90 minutes before game time and 30 minutes after start time
            var lateCutoff = __WEBPACK_IMPORTED_MODULE_0_moment___default()(this.cycle.starts_at).subtract(90, 'minutes');
            var superLateCutoff = __WEBPACK_IMPORTED_MODULE_0_moment___default()(this.cycle.starts_at).add(30, 'minutes');

            console.log('superLate', __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBetween(lateCutoff, superLateCutoff));
            return __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBetween(lateCutoff, superLateCutoff);
        },
        gameToday: function gameToday() {
            var gameToday = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.find(this.cycle.weeks, function (week) {
                return __WEBPACK_IMPORTED_MODULE_0_moment___default()().startOf('day').diff(__WEBPACK_IMPORTED_MODULE_0_moment___default()(week.starts_at).startOf('day')) == 0;
            });
        ...
        subSignupAllowed: function subSignupAllowed() {
            // as long as its
            console.log('subSignupAllowed', __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBefore(__WEBPACK_IMPORTED_MODULE_0_moment___default()(this.cycle.ends_at)));
            return __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBefore(__WEBPACK_IMPORTED_MODULE_0_moment___default()(this.cycle.ends_at));
        },
        subSignupLate: function subSignupLate() {
            if (!this.gameToday) return false;
            var closesAt = __WEBPACK_IMPORTED_MODULE_0_moment___default()(this.gameToday.starts_at).subtract(3, 'hours');
            var lateCutoff = __WEBPACK_IMPORTED_MODULE_0_moment___default()(this.gameToday.starts_at).subtract(90, 'minutes');

            console.log('subSignupLate', __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBetween(closesAt, lateCutoff));
            return __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBetween(closesAt, lateCutoff);
        },
        subSignupSuperLate: function subSignupSuperLate() {
            if (!this.gameToday) return false;
            var lateCutoff = __WEBPACK_IMPORTED_MODULE_0_moment___default()(this.gameToday.starts_at).subtract(90, 'minutes');
            var superLateCutoff = __WEBPACK_IMPORTED_MODULE_0_moment___default()(this.gameToday.starts_at);

            console.log('subSignupSuperLate', __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBetween(lateCutoff, superLateCutoff));
            return __WEBPACK_IMPORTED_MODULE_0_moment___default()().isBetween(lateCutoff, superLateCutoff);
        },
        signingUpForToday: function signingUpForToday() {
            var signUpForToday = false;
        ...
        late_message: function late_message() {
            var message = '';
            ...
            if (this.numOfWeeksSigningUp > 1 && this.cycleSignupAllowed && this.cycleSignupLate) {
            ...
            if (this.cycleSignupSuperLate || this.subSignupSuperLate) {
                message = "<p class='card-text'>Whoa! Game time is " + __WEBPACK_IMPORTED_MODULE_0_moment___default()(this.gameToday.starts_at).fromNow() + " and we're probably on our way to fields.</p>";
    ...
    mounted: function mounted() {
        ...
        this.division_preference_second = this.user.division_preference_second ? this.user.division_preference_second : this.user.division_preference_first;
      ...
      _c(
        ...
        [
          _c("transition", { attrs: { name: "fade", mode: "out-in" } }, [
            _vm.show == "intro"
              ? _c("div", { key: "intro", staticClass: "card m-2" }, [
                  _c("div", { staticClass: "card-body" }, [
                    _c("h4", [
                      _vm._v(
                        "Great to have you, " + _vm._s(_vm.user.nickname) + "!"
                      )
                    ]),
                    _vm._v(" "),
                    _c("p", [
                      _vm._v(
                        "We just need some information to sign you up for Cycle " +
                          _vm._s(_vm.cycle.name) +
                          "."
                      )
                    ]),
                    _vm._v(" "),
            ...
            _vm._v(" "),
            _vm.show == "div_pref"
              ? _c("div", { key: "div_pref", staticClass: "card m-2" }, [
                  _c("div", { staticClass: "card-body" }, [
                    _c("h4", { staticClass: "text-center" }, [
                      _vm._v("Division Preference")
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "row" }, [
                      _c("div", { staticClass: "col" }, [
                        _c("div", { staticClass: "w-100 m-1" }, [
                          _c(
                            "div",
                            {
                              staticClass: "card text-center w-100",
                              class: {
                                "bg-success": _vm.div_pref("genderOnly")
                              },
                              attrs: { "data-div_pref": "genderOnly" },
                              on: { click: _vm.clickPref }
                            },
                            [
                              _c("div", { staticClass: "card-body" }, [
                                _c(
                                  "p",
                                  {
                                    ...
                                    class: {
                                      "text-white": _vm.div_pref("genderOnly")
                                    }
                                  },
                                  [
                                    _vm._v(
                        ...
                        _c("div", { staticClass: "w-100 m-1" }, [
                          _c(
                            "div",
                            {
                              staticClass: "card text-center w-100",
                              class: {
                                "bg-success": _vm.div_pref("mixedOnly")
                              },
                              attrs: { "data-div_pref": "mixedOnly" },
                              on: { click: _vm.clickPref }
                            },
                            [
                              _c("div", { staticClass: "card-body" }, [
                                _c(
                                  "p",
                                  {
                                    staticClass: "card-text",
                                    class: {
                                      "text-white": _vm.div_pref("mixedOnly")
                                    }
                                  },
                                  [
                                    _vm._v(
                        ...
                        _c("div", { staticClass: "w-100 m-1" }, [
                          _c(
                            "div",
                            {
                              staticClass: "card text-center w-100",
                              class: {
                                "bg-success": _vm.div_pref("genderFlexible")
                              },
                              attrs: { "data-div_pref": "genderFlexible" },
                              on: { click: _vm.clickPref }
                            },
                            [
                              _c("div", { staticClass: "card-body" }, [
                        ...
                        _c("div", { staticClass: "w-100 m-1" }, [
                          _c(
                            "div",
                            {
                              staticClass: "card text-center w-100",
                              class: {
                                "bg-success": _vm.div_pref("mixedFlexible")
                              },
                              attrs: { "data-div_pref": "mixedFlexible" },
                              on: { click: _vm.clickPref }
                            },
                            [
                              _c("div", { staticClass: "card-body" }, [
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.show == "availability"
              ? _c("div", { key: "availability", staticClass: "card m-2" }, [
                  _c("div", { staticClass: "card-body" }, [
                    _c("div", { staticClass: "row justify-content-center" }, [
                      _c("h4", { staticClass: "text-center mb-5" }, [
                        _vm._v("Which weeks are you available?")
                      ]),
                      _vm._v(" "),
                      _c(
                        "div",
                        ...
                        _vm._l(_vm.cycle.weeks, function(week) {
                          return _c(
                            "div",
                            {
                              key: week.id,
                              staticClass: "card mx-1 mx-sm-2 text-center",
                              class: {
                                "bg-success": _vm.weekAttending(week.id),
                                "bg-danger": !_vm.weekAttending(week.id)
                              },
                              attrs: {
                                "data-week_id": week.id,
                                fontsize: _vm.timeFontSize
                              },
                              on: { click: _vm.clickWeek }
                            },
                            [
                              _c(
                                "div",
                                {
                                  staticClass:
                                    "card-body px-3 px-sm-4 py-2 m-1 m-sm-2"
                                },
                                [
                                  _c(
                                    "div",
                                  ...
                                  _c(
                                    ...
                                    [
                                      _vm.weekAttending(week.id)
                                        ? _c("i", {
                                            staticClass:
                                              "fa fa-fw fa-check-circle text-white"
                                          })
                                        : _vm._e(),
                                      _vm._v(" "),
                                      !_vm.weekAttending(week.id)
                    ...
                    _c(
                      "button",
                      {
                        staticClass: "btn btn-primary btn-block mt-3",
                        attrs: {
                          disabled: this.numOfWeeksSigningUp == 0 ? true : false
                        },
                        on: { click: _vm.clickContinue }
                      },
                      [_vm._v("Continue")]
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.show == "sub_message"
              ? _c("div", { key: "sub_message", staticClass: "card m-2" }, [
                  _c("div", { staticClass: "card-body" }, [
                    _c("h4", { staticClass: "text-center" }, [
                      _vm._v("Sub sign-up")
                    ]),
                    _vm._v(" "),
                    _c("div", {
                      staticClass: "card-text text-warning",
                      domProps: { innerHTML: _vm._s(_vm.sub_message) }
                    }),
                    _vm._v(" "),
                    _c(
                      "button",
            ...
            _vm._v(" "),
            _vm.show == "captain"
              ? _c("div", { key: "captain", staticClass: "card m-2" }, [
                  _c("div", { staticClass: "card-body" }, [
                    _c("h4", { staticClass: "text-center" }, [
                      _vm._v("Captain")
                    ]),
                    ...
                    _c("p", [
                      _vm._v(
                        "Awesome. Since you are available all 3 weeks, you're eligible to captain. Interested?"
                      )
                    ]),
                    _vm._v(" "),
                    _c("div", { attrs: { role: "tab", id: "duties_q" } }, [
                      _c("h6", [
                        _c(
                          "a",
                          {
                            attrs: {
                              ...
                              "data-parent": "#faq_list",
                              href: "#duties_a",
                              "aria-expanded": "'false'",
                              "aria-controls": "duties_a"
                            }
                          },
                          [
                            _vm._v(
                    ...
                    _vm._v(" "),
                    _c("div", { attrs: { role: "tab", id: "benifits_q" } }, [
                      _c("h6", [
                        _c(
                          "a",
                          {
                    ...
                    _c(
                      ...
                      [
                        _c("div", [
                          _c("p", [
                            _vm._v(
                              "A chance to practice your team captain and leadership skills. You get to help split up the teams. You will have influence over what the team will be working on that current cycle. And you get a 25% discount on the respective cycle fee."
                            )
                          ])
                        ])
                      ]
                    ...
                    _c("div", { staticClass: "card-deck" }, [
                      _c(
                        "div",
                        {
                          ...
                          class: { "bg-success": _vm.will_captain },
                          attrs: { "data-answer": "true" },
                          on: { click: _vm.clickCaptain }
                        },
                        [
                          _c("div", { staticClass: "card-body" }, [
                            _c(
                              ...
                              {
                                staticClass: "card-text",
                                class: { "text-white": _vm.will_captain }
                              },
                              [_vm._v("Yeah, I'll Captain!")]
                            )
                          ])
                        ]
                      ),
                      ...
                      _c(
                        ...
                        {
                          staticClass: "card text-center",
                          class: { "bg-danger": _vm.will_captain == false },
                          attrs: { "data-answer": "false" },
                          on: { click: _vm.clickCaptain }
                        },
                        [
                          _c("div", { staticClass: "card-body" }, [
                            _c(
                              "p",
                              {
                                staticClass: "card-text",
                                class: {
                                  "text-white": _vm.will_captain == false
                                }
                              },
                              [_vm._v("Nah, just play.")]
                            )
                          ])
                        ]
                      )
                    ...
                    _c(
                      "button",
                      {
                        staticClass: "btn btn-primary btn-block mt-3",
                        attrs: {
                          disabled: this.will_captain == null ? true : false
                        },
                        on: { click: _vm.clickContinue }
                      },
                      [_vm._v("Continue")]
            ...
            _vm._v(" "),
            _vm.show == "payment"
              ? _c("div", { key: "payment", staticClass: "card m-2" }, [
                  _c("div", { staticClass: "card-body" }, [
                    _c("h4", { staticClass: "text-center" }, [
                    ...
                    _c("p", { staticClass: "card-text" }, [
                      _vm._v(
                        "Once you are placed on a team, your account will be charged $" +
                          _vm._s(_vm.fees) +
                          "."
                      )
                    ]),
                      ...
                      _c(
                        "select",
                        {
                          ...
                          attrs: {
                            name: "payment_type",
                            id: "payment_type",
                            "aria-describedby": "payment_typeHelp",
                            placeholder: "Required payment type",
                            required: ""
                          },
                          on: { change: _vm.selectPaymentMethod }
                        },
                        [
                          _c(
                            "option",
                            { attrs: { diabled: "", selected: "" } },
                            [_vm._v("Choose method")]
                          ),
                          _vm._v(" "),
                          _c("option", { attrs: { value: "chase_quickpay" } }, [
                            _vm._v("Chase Quickpay")
                          ]),
                          _vm._v(" "),
                          _c("option", { attrs: { value: "venmo" } }, [
                            _vm._v("Venmo")
                          ]),
                          _vm._v(" "),
                          _c("option", { attrs: { value: "square_cash" } }, [
                            _vm._v("Square Cash")
                          ]),
                          _vm._v(" "),
                    ...
                    _c(
                      "button",
                      {
                        staticClass: "btn btn-primary btn-block mt-3",
                        attrs: {
                          disabled: this.payment_method == null ? true : false
                        },
                        on: { click: _vm.clickContinue }
                      },
                      [_vm._v("Continue")]
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.show == "late_message"
              ? _c("div", { key: "late_message", staticClass: "card m-2" }, [
                  _c("div", { staticClass: "card-body" }, [
                    _c("h4", { staticClass: "text-center" }, [
                      _vm._v("Late Sign-up")
                    ]),
                    _vm._v(" "),
                    _c("div", {
                      staticClass: "card-text text-danger",
                      domProps: { innerHTML: _vm._s(_vm.late_message) }
                    }),
                    _vm._v(" "),
                    _c(
                      "button",
            ...
            _vm._v(" "),
            _vm.show == "note"
              ? _c("div", { key: "note", staticClass: "card m-2" }, [
                  _c("div", { staticClass: "card-body" }, [
                    _c("div", { staticClass: "form-group" }, [
                      _c("label", { attrs: { for: "note" } }, [
                        _vm._v("Anything else you want to tell us?")
                      ]),
                      _vm._v(" "),
                      _c("textarea", {
                        staticClass: "form-control",
            ...
            _vm._v(" "),
            _vm.show == "confirm"
              ? _c("div", { key: "confirm", staticClass: "card m-2" }, [
                  _c("div", { staticClass: "card-body" }, [
                    ...
                    _c("dl", [
                      _c("dt", { staticClass: "text-muted" }, [
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "align-baseline btn btn-link d-inline btn-sm",
                            attrs: { type: "button", "data-show": "div_pref" },
                            on: { click: _vm.clickConfirmEdit }
                          },
                          [_vm._v("Edit")]
                        )
                      ]),
                      ...
                      _c("dd", { staticClass: "ml-2" }, [
                        _vm._v(
                          "\n                                " +
                            _vm._s(this.division_preference) +
                            "\n                            "
                        )
                      ]),
                      _vm._v(" "),
                      _c("dt", { staticClass: "text-muted" }, [
                        _vm._v(
                          "\n                                Weeks " +
                            _vm._s(this.subSignup ? "Subbing" : "Playing") +
                            "\n                                "
                        ),
                        _c(
                          "button",
                      ...
                      _c("dd", {
                        staticClass: "ml-2",
                        domProps: { innerHTML: _vm._s(this.weeksAttendingList) }
                      }),
                      _vm._v(" "),
                        ...
                        ? _c("dd", { staticClass: "ml-2" }, [
                            _vm._v(
                              "\n                                " +
                                _vm._s(
                                  this.will_captain
                                    ? "Yes. (Thank You! We'll let you know.)"
                                    : "No"
                                ) +
                                "\n                            "
                            )
                      ...
                      _c("dt", { staticClass: "text-muted" }, [
                        ...
                        _c(
                          "button",
                          {
                            staticClass:
                              "align-baseline btn btn-link d-inline btn-sm",
                            attrs: { type: "button", "data-show": "payment" },
                            on: { click: _vm.clickConfirmEdit }
                          },
                          [_vm._v("Edit")]
                        )
                      ...
                      _c("dd", {
                        staticClass: "ml-2",
                        domProps: {
                          innerHTML: _vm._s(this.paymentConfirmation)
                        }
                      }),
                      _vm._v(" "),
                      _c("dt", { staticClass: "text-muted" }, [
                        ...
                        _c(
                          "button",
                          {
                            staticClass:
                              "align-baseline btn btn-link d-inline btn-sm",
                            attrs: { type: "button", "data-show": "note" },
                            on: { click: _vm.clickConfirmEdit }
                          },
                          [_vm._v("Edit")]
                        )
                      ...
                      this.note == null
                        ? _c(
                            "dd",
                            { staticClass: "ml-2 text-muted font-italic" },
                            [
                              _vm._v(
                                "\n                                no note\n                            "
                              )
            ...
            _vm._v(" "),
            _vm.show == "success"
              ? _c("div", { key: "success", staticClass: "card m-2" }, [
                  _c("div", { staticClass: "card-body" }, [
                    _c("h5", [
                      _vm._v(
                    ...
                    _vm._v(" "),
                    _c("h5", [_vm._v("See you at the fields!")]),
                    _vm._v(" "),
                    _c(
                      "button",
                      {
                        staticClass: "btn btn-success btn-block mt-3",
                        on: { click: _vm.clickCycleDetails }
                      },
                      [_vm._v("Back to Cycle")]
                    )
                  ])
                ])
              : _vm._e()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-bf2ab392", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-5dda7224"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/js/components/SignupsCard.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5dda7224", Component.options)
  } else {
    hotAPI.reload("data-v-5dda7224", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5dda7224\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SignupsCard.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5dda7224\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SignupsCard.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.fade-enter-active[data-v-5dda7224], .fade-leave-active[data-v-5dda7224] {\n  -webkit-transition: opacity .5s;\n  transition: opacity .5s;\n}\n.fade-enter[data-v-5dda7224], .fade-leave-to[data-v-5dda7224] /* .fade-leave-active below version 2.1.8 */ {\n  opacity: 0;\n}\ntime.icon.icon-sm[data-v-5dda7224] {\n    font-size:0.6em;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        notOnATeam: function notOnATeam() {
            var _this = this;

            if (this.cycle == '') return [];
            if (this.gender !== undefined) {
                return this.cycle.signups.filter(function (signup) {
                    return signup.gender.toLowerCase() === _this.gender && signup.pivot.team_id === null;
                });
            } else {
        ...
        weekCounts: function weekCounts() {
            var arr = [];
            if (this.cycle == '') return [];
            for (var i = 0, len = this.cycle.weeks.length; i < len; i++) {
                ...
                try {
                    for (var _iterator = this.notOnATeam[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        var signup = _step.value;
    ...
    methods: {
        addToTeam: function addToTeam(payload) {
            this.$emit('addToTeam', payload);
        },
        isAvailable: function isAvailable(signup, weekId) {
            var wkId = weekId;
    ...
    events: {
        teamPlacement: function teamPlacement(signupId, teamId) {
  ...
  return _c("div", { staticClass: "card" }, [
    ...
    _c("div", { staticClass: "card-body p-0" }, [
      _c("table", { staticClass: "table table-sm table-striped mb-0" }, [
        _c("tbody", [
          _c(
            ...
            [
              _c("th", [_vm._v("Name")]),
              _vm._v(" "),
              _c("th", { staticClass: "text-center" }, [_vm._v("Div1")]),
              _vm._v(" "),
              _c("th", { staticClass: "text-center" }, [_vm._v("Div2")]),
              _vm._v(" "),
              _vm._l(_vm.cycle.weeks, function(week, key) {
                return _c("th", { key: week.id, staticClass: "text-center" }, [
                  _vm._v("Wk" + _vm._s(key + 1))
                ])
              }),
              _vm._v(" "),
              _vm._m(0),
        ...
        _c(
          "tbody",
          _vm._l(_vm.notOnATeam, function(signup) {
            return _c("signup", {
              key: signup.id,
              tag: "tr",
              attrs: { cycle: _vm.cycle, signup: signup }
            })
          })
        ),
        _vm._v(" "),
        _c("tbody", [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _vm._l(_vm.weekCounts, function(count, key) {
                return _c("th", { key: key, staticClass: "text-center" }, [
                  _vm._v(_vm._s(count))
                ])
              }),
              _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5dda7224", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        teamOptions: function teamOptions() {
            var content = [];
            var _iteratorNormalCompletion = true;
            var _didIteratorError = false;
            var _iteratorError = undefined;
            ...
            try {
                for (var _iterator = this.cycle.teams[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    if (this.signup.gender.toLowerCase() == 'male' && (team.division.toLowerCase() == 'mixed' || team.division.toLowerCase() == 'mens')) {
                        content.push(data);
                    }
                    if (this.signup.gender.toLowerCase() === 'female' && (team.division.toLowerCase() == 'mixed' || team.division.toLowerCase() == 'womens')) {
                        content.push(data);
                    }
                }
            } catch (err) {
        ...
        nicknameOrShortName: function nicknameOrShortName() {
            var pieces = [];
    ...
    methods: {
        addToTeam: function addToTeam(event) {
        ...
        toggleCaptain: function toggleCaptain(event) {
        ...
        availabilityIconClass: function availabilityIconClass(week) {
        ...
        updateTeamOnServer: function updateTeamOnServer(signup) {
        ...
        updateCaptainOnServer: function updateCaptainOnServer(signup) {
            axios.put('/api/cyclesignups/' + signup.pivot.id, {
  ...
  return _c(
    ...
    [
      _c("td", { staticClass: "pl-3" }, [
        _c("a", { attrs: { title: "signup.name", href: "/users/signup.id" } }, [
          _vm._v(_vm._s(_vm.nicknameOrShortName))
        ]),
        _vm._v(" "),
        _vm.signup.pivot.captain
          ? _c("span", [_c("i", { staticClass: "fa fa-star text-warning" })])
          : _vm._e(),
        _vm._v(" "),
        _vm.signup.pivot.note
          ? _c("span", [
              _c("i", {
                staticClass: "fa fa-sticky-note text-warning",
                attrs: {
                  "data-toggle": "tooltip",
      ...
      _c("td", { staticClass: "text-center" }, [
        _c("span", {
          domProps: {
            innerHTML: _vm._s(
              _vm.teamDivisionIcon(_vm.signup.pivot.div_pref_first)
            )
          }
        })
      ]),
      ...
      _c("td", { staticClass: "text-center" }, [
        _c("span", {
          domProps: {
            innerHTML: _vm._s(
              _vm.teamDivisionIcon(_vm.signup.pivot.div_pref_second)
            )
          }
        })
      ]),
      ...
      _vm._l(_vm.cycle.weeks, function(week) {
        return _c("td", { staticClass: "text-center" }, [
          _c("i", { class: _vm.availabilityIconClass(week) })
        ])
      }),
      _vm._v(" "),
      _c(
        "td",
        { staticClass: "text-center", on: { click: _vm.toggleCaptain } },
        [
          _vm.signup.pivot.will_captain
            ? _c("i", { staticClass: "fa fa-thumbs-up fa-fw text-primary" })
            : _c("i", { staticClass: "fa fa-thumbs-down text-default" })
        ]
      ),
      _vm._v(" "),
      _c("td", { staticClass: "text-center" }, [
...
Component.options.__file = "resources/assets/js/components/TeamCard.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4edc3478", Component.options)
  } else {
    hotAPI.reload("data-v-4edc3478", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        players: function players() {
            ...
            return this.cycle.signups.filter(function (signup) {
                return signup.pivot.team_id == _this.team.id;
            });
        },
...
var render = function() {
  ...
  return _c("div", { staticClass: "card" }, [
    _c("div", { staticClass: "card-header" }, [
      ...
      _c("span", {
        domProps: { innerHTML: _vm._s(_vm.teamDivisionIcon(_vm.team.division)) }
      })
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "card-body p-0" }, [
      _c("div", { staticClass: "table-responsive" }, [
        _c(
          ...
          [
              ...
              _c(
                ...
                [
                  ...
                  _vm._l(_vm.cycle.weeks, function(week, key) {
                    return _c(
                      "th",
                      { key: week.id, staticClass: "text-center" },
                      [_vm._v("Wk" + _vm._s(key + 1))]
                    )
                  }),
                  _vm._v(" "),
            ...
            _vm._v(" "),
            _vm._l(_vm.players, function(signup) {
              return _vm.team.division.toLowerCase() !== "womens"
                ? _c("tbody", [
                    signup.gender.toLowerCase() === "male"
                      ? _c("signup", {
                          tag: "tr",
                          attrs: { signup: signup, cycle: _vm.cycle }
                        })
                      : _vm._e()
                  ])
                : _vm._e()
            ...
            _vm._v(" "),
            _vm.team.division.toLowerCase() === "mixed"
              ? _c("tr", { staticClass: "warning" }, [
                  _c("th", { attrs: { colspan: "5" } }, [_vm._v("Females")])
                ])
              : _vm._e(),
            _vm._v(" "),
            _vm._l(_vm.players, function(signup) {
              return _vm.team.division.toLowerCase() !== "mens"
                ? _c("tbody", [
                    signup.gender.toLowerCase() === "female"
                      ? _c("signup", {
                          tag: "tr",
                          attrs: { signup: signup, cycle: _vm.cycle }
                        })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4edc3478", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/TeamBuilder.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0f075717", Component.options)
  } else {
    hotAPI.reload("data-v-0f075717", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col" }, [
        _c("h5", [_vm._v("Cycle " + _vm._s(_vm.cycle.name) + " Team Builder")]),
        _vm._v(" "),
        _c("p", [_vm._v("Create and add/remove players to teams")])
      ])
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col col-sm-3" }, [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _vm._l(_vm.cycle.teams, function(team) {
              return _c(
                "li",
                ...
                [
                  ...
                  _c("span", {
                    domProps: {
                      innerHTML: _vm._s(_vm.teamDivisionIcon(team.division))
                    }
                  }),
                  _vm._v(" "),
                  _c(
        ...
        _vm._v(" "),
        !_vm.cycle.teams_published
          ? _c(
              "button",
              {
                staticClass:
                  "btn btn-primary btn-lg btn-block js-publish-teams mt-3",
                attrs: {
                  type: "button",
                  "data-toggle": "modal",
                  "data-target": "#publishTeamsModal"
                }
              },
              [
                _vm._v(
          ...
          : _c("div", [
              _c(
                "button",
                {
                  ...
                  attrs: {
                    type: "button",
                    "data-toggle": "modal",
                    "data-target": "#announceTeamsModal"
                  }
                },
                [
                  _vm._v(
              ...
              _c(
                "a",
                {
                  ...
                  attrs: {
                    href: "/cycles/" + _vm.cycle.id + "/teams/unpublish"
                  }
                },
                [_vm._v("Unpublish teams")]
              )
            ])
      ])
    ]),
    ...
    _c("div", { staticClass: "row mt-3" }, [
      _c(
        ...
        [
          _c("signups-card", {
            attrs: { title: "Male signups", gender: "male", cycle: _vm.cycle }
          })
        ],
        1
      ),
    ...
    _c(
      ...
      _vm._l(_vm.cycle.teams, function(team) {
        return _c(
          "div",
          { key: team.id, staticClass: "col-12 col-sm-6" },
          [_c("team-card", { attrs: { team: team, cycle: _vm.cycle } })],
          1
        )
      })
    )
...
var staticRenderFns = [
  function() {
    ...
    return _c("li", { staticClass: "list-group-item" }, [
      _c("a", { attrs: { href: "/teams/create" } }, [_vm._v("Add Team")])
    ])
  }
]
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0f075717", module.exports)
  }
}
