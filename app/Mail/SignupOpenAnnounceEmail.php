...
class SignupOpenAnnounceEmail extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        return $this->from('support@focusleague.com', 'FOCUS League')
                    ->subject('Cycle ' . $this->cycle->name . ' sign-up is open!')
                    ->markdown('emails.signup_open_announce')
