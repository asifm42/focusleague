    ...
    <div class="card mt-4 mb-4">
        <div class="card-body">
            ...
            <div class="form-group {{ $errors->has('club_affiliation') ? 'has-danger' : ''}}">
                ...
                <input name="club_affiliation" type="text" class="form-control {{ $errors->has('club_affiliation') ? 'is-invalid' : ''}}" id="club_affiliation" aria-describedby="nameHelp" placeholder='Required club affiliation' required value={{ old('club_affiliation', $history->club_affiliation) }}>
            ...
            <div class="form-group {{ $errors->has('years_played') ? 'has-danger' : ''}}">
                ...
                <select name="years_played" class="form-control div_pref_2-js {{ $errors->has('years_played') ? 'is-invalid' : ''}}" id="years_played" aria-describedby="years_playedHelp" placeholder="Required years played" required>
                    ...
                    @foreach($years_played_options as $key => $option)
                        <option value={{ $key }} {{ old('years_played', $history->years_played) == $key ? 'selected' : '' }}>{{ $option }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group {{ $errors->has('summary') ? 'has-danger' : ''}}">
                ...
                <textarea name="summary" type="text" class="form-control {{ $errors->has('summary') ? 'is-invalid' : ''}}" id="summary" aria-describedby="nameHelp" placeholder='Required summay'>{{ old('summary', $history->summary) }}</textarea>
            ...
            <div class="form-group {{ $errors->has('def_or_off') ? 'has-danger' : ''}}">
                ...
                <select name="def_or_off" class="form-control div_pref_2-js {{ $errors->has('def_or_off') ? 'is-invalid' : ''}}" id="def_or_off" aria-describedby="def_or_offHelp" placeholder="Required defensive or offensive" required>
                    ...
                    <option value="Defensive" {{ old('def_or_off', $history->def_or_off) == 'Defensive' ? 'selected' : '' }}>Defensive</option>
                    <option value="Offensive" {{ old('def_or_off', $history->def_or_off) == 'Offensive' ? 'selected' : '' }}>Offensive</option>
                </select>
            ...
            <div class="form-group {{ $errors->has('fav_offensive_position') ? 'has-danger' : ''}}">
                ...
                <input name="fav_offensive_position" type="text" class="form-control {{ $errors->has('fav_offensive_position') ? 'is-invalid' : ''}}" id="fav_offensive_position" aria-describedby="fav_offensive_positionHelp" placeholder='Required favorite offensive position' required value={{ old('fav_offensive_position', $history->fav_offensive_position) }}>
            ...
            <div class="form-group {{ $errors->has('fav_defensive_position') ? 'has-danger' : ''}}">
                ...
                <input name="fav_defensive_position" type="text" class="form-control {{ $errors->has('fav_defensive_position') ? 'is-invalid' : ''}}" id="fav_defensive_position" aria-describedby="fav_defensive_positionHelp" placeholder='Required favorite defensive position' required value={{ old('fav_defensive_position', $history->fav_defensive_position) }}>
            ...
            <div class="form-group {{ $errors->has('best_skill') ? 'has-danger' : ''}}">
                ...
                <input name="best_skill" type="text" class="form-control {{ $errors->has('best_skill') ? 'is-invalid' : ''}}" id="best_skill" aria-describedby="best_skillHelp" placeholder='Required best ultimate skill' required value={{ old('best_skill', $history->best_skill) }}>
            ...
            <div class="form-group {{ $errors->has('skill_to_improve') ? 'has-danger' : ''}}">
                ...
                <input name="skill_to_improve" type="text" class="form-control {{ $errors->has('skill_to_improve') ? 'is-invalid' : ''}}" id="skill_to_improve" aria-describedby="skill_to_improveHelp" placeholder='Required skill you want to improve' required value={{ old('skill_to_improve', $history->skill_to_improve) }}>
            ...
            <div class="form-group {{ $errors->has('best_throw') ? 'has-danger' : ''}}">
                ...
                <input name="best_throw" type="text" class="form-control {{ $errors->has('best_throw') ? 'is-invalid' : ''}}" id="best_throw" aria-describedby="best_throwHelp" placeholder='Required best ultimate throw' required value={{ old('best_throw', $history->best_throw) }}>
            ...
            <div class="form-group {{ $errors->has('throw_to_improve') ? 'has-danger' : ''}}">
                ...
                <input name="throw_to_improve" type="text" class="form-control {{ $errors->has('throw_to_improve') ? 'is-invalid' : ''}}" id="throw_to_improve" aria-describedby="throw_to_improveHelp" placeholder='Required throw you want to improve' required value={{ old('throw_to_improve', $history->throw_to_improve) }}>
