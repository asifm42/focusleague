    ...
    <div class="card mt-4 mb-4">
        <div class="card-body">
            ...
            <div class="form-group {{ $errors->has('birthday') ? 'has-danger' : ''}}">
                ...
                <input name="birthday" type="date" class="form-control {{ $errors->has('birthday') ? 'is-invalid' : ''}}" id="birthday" aria-describedby="birthdayHelp" placeholder="Required birthday" required value={{ old('birthday', $user->birthday) }}>
