...
use App\Mail\Alert\SubSignupUpdateAlert;
...
class SubSignupUpdateAlertTest extends TestCase
{
    use DatabaseMigrations;

    /** @test */
    function sub_signup_update_alert_is_being_sent()
    {
        Mail::fake();
        ...
        $mailer->sendSubSignUpUpdateAlert($sub, $sub->user);

        Mail::assertSent(SubSignupUpdateAlert::class, function ($mail) {
